...
public abstract class AbstractTestResult extends DefaultResult implements TestResult {
    ...
    public void setStatus(String status){
        this.status = status;
        if(status.equals(TestPlan.TS_ERROR) || status.equals(TestPlan.TS_FAILURE)){
            setFailure();
        }
    }
