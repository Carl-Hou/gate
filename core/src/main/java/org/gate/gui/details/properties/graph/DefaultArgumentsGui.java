...
public class DefaultArgumentsGui extends AbstractGraphElementPanel {
    ArgumentsPane argumentsPane = new ArgumentsPane(getBorderName());

    public DefaultArgumentsGui(){
        add(argumentsPane);
    }
