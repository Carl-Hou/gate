...
public class SetupResult extends ModelContainerResult{

    public SetupResult(String suiteName, String modelName){
        super(suiteName, modelName);
    }
// for before test suites
    public SetupResult(String modelName){
