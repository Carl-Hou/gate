...
public class HTTPRequestDefaults extends DefaultsConfigElement implements HTTPConstantsInterface {


    public HTTPRequestDefaults(){
        addConfigProperty(PN_Protocol, "");
        addConfigProperty(PN_ServerNameIP, "");
        addConfigProperty(PN_PortNumber, "");
        addConfigProperty(PN_ContentEncoding, "");
        addConfigProperty(PN_ConnectTimeout, "");
        addConfigProperty(PN_ResponseTimeout, "");
    }
