...
public class New extends AbstractGateAction {
    ...
    public void doAction(ActionEvent e) throws IllegalUserActionException {
        GuiPackage.getIns().getMainFrame().setTestFile(null);
        GuiPackage.getIns().getMainFrame().closeModelEditor();
        GuiPackage.getIns().getMainFrame().updateTitle();
        GateTreeSupport.cleanCache();
        GuiPackage.getIns().getActionTree().reset();
        GuiPackage.getIns().getTestTree().reset();
