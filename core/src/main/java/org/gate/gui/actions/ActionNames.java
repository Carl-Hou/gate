...
public final class ActionNames {
    ...
    public static final String ADD_TO_TREE      = "add_to_tree"; // $NON-NLS-1$
    public static final String ADD_TO_Graph     = "add_to_graph"; // $NON-NLS-1$
    ...
    public static final String LOG_LEVEL_ERROR  = "log_Level_error"; // $NON-NLS-1$
    public static final String LOG_LEVEL_WARN   = "log_Level_warn"; // $NON-NLS-1$
    public static final String LOG_LEVEL_INFO   = "log_Level_info"; // $NON-NLS-1$
    public static final String LOG_LEVEL_DEBUG  = "log_Level_debug"; // $NON-NLS-1$
    public static final String LOG_LEVEL_TRACE  = "log_Level_trace"; // $NON-NLS-1$
