...
import org.gate.gui.sslmanager.SSLManager;
 ...
 *
 */
public class SSLManagerCommand extends AbstractGateAction {
...
//        int retVal = keyStoreChooser.showOpenDialog(GuiPackage.getInstance().getMainFrame());
        int retVal = keyStoreChooser.showOpenDialog(null);
    ...
    static private class AcceptPKCS12FileFilter extends FileFilter {
        ...
        public String getDescription() {
            return "PKCS 12 Key (*.p12)"; //$NON-NLS-1$
        }
