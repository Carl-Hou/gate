...
public class SeleniumCodeSnippetGui extends JPanel implements GraphElementPropertiesGui {
    ...
    public SeleniumCodeSnippetGui(){
        ...
        propsScript.setRightComponent(GuiUtils.getRTextScrollPane(rSyntaxTextArea, "Groovy Script (Variables: driver, SampleResult)"));
        add(propsScript);
