...
package org.gate.gui.graph.elements.sampler.protocol.http.hc;
...
import org.gate.gui.sslmanager.HttpSSLProtocolSocketFactory;
import org.gate.gui.sslmanager.JsseSSLManager;
...
public final class LazyLayeredConnectionSocketFactory implements LayeredConnectionSocketFactory{
    ...
    private static final String PROTOCOL_LIST =
            GateProps.getProperty("https.socket.protocols", ""); // $NON-NLS-1$ $NON-NLS-2$

    private static final String CIPHER_LIST =
            GateProps.getProperty("https.socket.ciphers", ""); // $NON-NLS-1$ $NON-NLS-2$
