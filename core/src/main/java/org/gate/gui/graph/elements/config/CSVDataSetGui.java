...
import org.gate.gui.graph.elements.config.CSVDataSet;
import org.gate.gui.graph.elements.sampler.DebugSampler;

public class CSVDataSetGui extends DefaultPropertiesGui {
    @Override
    protected void updateTableEditors() {
        defaultPropertiesTable.setBooleanOnCell(CSVDataSet.PN_SkipFirstLine);
