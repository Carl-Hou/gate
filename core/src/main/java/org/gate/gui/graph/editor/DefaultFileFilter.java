...
public class DefaultFileFilter extends FileFilter
{
	...
	/**
	 * Constructs a v1 filter for the specified extension and descpription.
	 * 
	 * @param extension
	...
	public static class ImageFileFilter extends FileFilter
	{
		...
		/**
		 * Constructs a v1 file filter for all supported image formats using
	...
	public static class EditorFileFilter extends FileFilter
	{
		...
		/**
		 * Constructs a v1 editor file filter using the specified description.
		 * 
		 * @param description
