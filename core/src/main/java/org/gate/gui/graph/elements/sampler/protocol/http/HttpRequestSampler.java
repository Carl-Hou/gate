...
import org.gate.gui.graph.elements.sampler.protocol.http.gui.DefaultHttpElementGui;
...
public class HttpRequestSampler extends AbstractGraphElement implements HTTPConstantsInterface, Sampler {
    ...
    public String getGUI() {
        return DefaultHttpElementGui.class.getName();
    }
