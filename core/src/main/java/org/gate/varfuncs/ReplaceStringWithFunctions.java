...
import org.gate.varfuncs.property.FunctionProperty;
...
//	variables is not used at all so remove it.
...
//    }
    ...
    @Override
    public GateProperty transformValue(GateProperty prop) throws InvalidVariableException {
        GateProperty newValue = prop;
