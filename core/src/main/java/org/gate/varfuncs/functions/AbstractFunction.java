...
public abstract class AbstractFunction implements Function {
     ...
     */
    @Override
    abstract public String executeRecursion() throws InvalidVariableException;
     ...
     */
    protected GateVariables getVariables() {
        return GateContextService.getContext().getVariables();
    }
