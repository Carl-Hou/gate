 ...
 * @since 2.6
 */
public class ThreadName extends AbstractFunction {

    private static final List<String> desc = new LinkedList<>();

    private static final String KEY = "__ThreadName"; //$NON-NLS-1$
    ...
    public String executeRecursion() throws InvalidVariableException {
        // ThreadName is set on thread created. this suppose to not have random value.
