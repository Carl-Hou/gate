...
public class TimeFunction extends AbstractFunction {
    ...
    static {
        desc.add("Format string for SimpleDateFormat (optional)"); //$NON-NLS-1$
        desc.add("Name of variable in which to store the result (optional)"); //$NON-NLS-1$
        aliases.put("YMD", //$NON-NLS-1$
                GateProps.getProperty("time.YMD","yyyyMMdd")); //$NON-NLS-1$
        aliases.put("HMS", //$NON-NLS-1$
                GateProps.getProperty("time.HMS", //$NON-NLS-1$
                        "HHmmss")); //$NON-NLS-1$
        aliases.put("YMDHMS", //$NON-NLS-1$
                GateProps.getProperty("time.YMDHMS", //$NON-NLS-1$
                        "yyyyMMdd-HHmmss")); //$NON-NLS-1$
        aliases.put("USER1", //$NON-NLS-1$
                GateProps.getProperty("time.USER1","")); //$NON-NLS-1$
        aliases.put("USER2", //$NON-NLS-1$
                GateProps.getProperty("time.USER2","")); //$NON-NLS-1$
    }
